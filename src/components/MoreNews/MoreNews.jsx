  ...
  return (
    <div className="more-news">
      ...
      <div className="more-news__container">
        {/* новость 1 */}
        <div className="more-news__item">
          <div className="more-news__time">
            <Link href="/politics" id="category">
              Политика
            </Link>
            <span id="date">1.01.2023, 13:53</span>
          </div>

          <h4 className="more-news__item_title">
        ...
        <div className="more-news__item">
          ...
          <h4 className="more-news__item_title">
            Раскрыты последствия уничтожения беспилотника в небе над
            Подмосковьем
          </h4>
